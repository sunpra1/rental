...
class TenanciesHistoryRVItemTouchListener(
    context: Context,
        ...
        object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                if (direction == ItemTouchHelper.LEFT) {
                    ...
                    callback.onTenancyHistoryMakeActiveSelected(viewHolder.adapterPosition)
                }
            }
            ...
            override fun onChildDraw(
                ...
                RecyclerViewSwipeDecorator.Builder(
                    ...
                    ).addSwipeRightActionIcon(R.drawable.restore)
                    .create()
                    .decorate()
            }
        }
    ...
    interface OnTenancyHistoryTouch {
        ...
        fun onTenancyHistoryMakeActiveSelected(position: Int)
